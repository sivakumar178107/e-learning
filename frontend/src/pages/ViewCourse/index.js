...
import { DELETE_COURSE, FETCHING_COURSE, SHOW_COURSE } from "../../redux/types/couserTypes";
                          ...
                          courses.map((course, index) => {
                            return (
                              <tr key={index + 1}>
                                ...
                                <td style={{ width: "10%" }}>
                                  <div style={{ maxHeight: '45px', minHeight: '45px', overflow: 'hidden' }}>
                                    <img
                                ...
                                <td style={{ width: "10%" }}>
                                  <HiEye
                                    ...
                                    role="button"
                                    onClick={() =>
                                      navigate(`/showcontent/${course._id}`)
                                    }
                                  />
                                </td>
